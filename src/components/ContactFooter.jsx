...
const ContactFooter = ({ price, currency, priceUnit }) => {
  ...
  return (
    <footer
      className="fixed bottom-0 left-0 right-0 bg-glass border-t border-ios-dark-separator safe-area-bottom safe-area-left safe-area-right z-50"
      style={{ position: 'fixed', bottom: 0, transform: 'translateZ(0)' }}
    >
      <div className="flex items-center px-4 py-2" style={{ minHeight: '56px' }}>
        ...
        <div className="flex-shrink-0" style={{ marginLeft: '16px' }}>
          ...
          <p className="text-xs text-ios-dark-secondary-label opacity-65">per {priceUnit}</p>
        </div>
